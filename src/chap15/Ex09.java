...
public class Ex09 {
    public static void main(String[] args) {
        ...
        Pig Pig = new Pig(lock);
        Wolf Wolf = new Wolf(lock);

        Thread threadp = new Thread(Pig);
        Thread threadw = new Thread(Wolf);
